...
$valeexamepref = mysqli_query($con,"SELECT count(*) from senha where servico_id = 9 AND data between '$dataini' and '$datafim'");
$farmacia = mysqli_query($con,"SELECT count(*) from senha where servico_id = 4 AND data between '$dataini' and '$datafim'");
$vacina = mysqli_query($con,"SELECT count(*) from senha where servico_id = 5 AND data between '$dataini' and '$datafim'");
$citomamografia = mysqli_query($con,"SELECT count(*) from senha where servico_id = 6 AND data between '$dataini' and '$datafim'");
$cartaosus = mysqli_query($con,"SELECT count(*) from senha where servico_id = 8 AND data between '$dataini' and '$datafim'");
...
while($row = mysqli_fetch_array($valeexamepref)) {
  echo "<tr>";
  echo "<td>" ."Vale Exame Preferencial". "</td>";
  echo "<td><center>" . $row['0'] . "</center></td>";
  echo "</tr>";
}
...
while($row = mysqli_fetch_array($citomamografia)) {
  echo "<tr>";
  echo "<td>" ."Cito - Mamografia". "</td>";
  echo "<td><center>" . $row['0'] . "</center></td>";
  echo "</tr>";
}
while($row = mysqli_fetch_array($cartaosus)) {
  echo "<tr>";
  echo "<td>" ."Cartão SUS". "</td>";
  echo "<td><center>" . $row['0'] . "</center></td>";
  echo "</tr>";
}
...
$consultorio02fernandes = mysqli_query($con,"SELECT count(*) from senha where usuario_id = 96 AND data between '$dataini' and '$datafim'");
...
$consultorio05ruber = mysqli_query($con,"SELECT count(*) from senha where usuario_id = 95 AND data between '$dataini' and '$datafim'");
$consultorio05manoel = mysqli_query($con,"SELECT count(*) from senha where usuario_id = 105 AND data between '$dataini' and '$datafim'");
$consultorio06luciana= mysqli_query($con,"SELECT count(*) from senha where usuario_id = 85 AND data between '$dataini' and '$datafim'");
$consultorio09rudney= mysqli_query($con,"SELECT count(*) from senha where usuario_id = 79 AND data between '$dataini' and '$datafim'");
...
$psicologia02sheila = mysqli_query($con,"SELECT count(*) from senha where usuario_id = 103 AND data between '$dataini' and '$datafim'");
$nutricaomilena= mysqli_query($con,"SELECT count(*) from senha where usuario_id = 109 AND data between '$dataini' and '$datafim'");
$nutricaoraquel= mysqli_query($con,"SELECT count(*) from senha where usuario_id = 37 AND data between '$dataini' and '$datafim'");
$nutricaoroberta= mysqli_query($con,"SELECT count(*) from senha where usuario_id = 97 AND data between '$dataini' and '$datafim'");
...
$consultorio14testepezinho = mysqli_query($con,"SELECT count(*) from senha where usuario_id = 42 AND data between '$dataini' and '$datafim'");
$citologia_mamografia = mysqli_query($con,"SELECT count(*) from senha where usuario_id = 99 AND data between '$dataini' and '$datafim'");
$eletrocardiograma = mysqli_query($con,"SELECT count(*) from senha where usuario_id = 41 AND data between '$dataini' and '$datafim'");
...
$odonto01vanessa = mysqli_query($con,"SELECT count(*) from senha where usuario_id = 45 AND data between '$dataini' and '$datafim'");
$odonto01flavia = mysqli_query($con,"SELECT count(*) from senha where usuario_id = 107 AND data between '$dataini' and '$datafim'");
$odonto01karolline = mysqli_query($con,"SELECT count(*) from senha where usuario_id = 108 AND data between '$dataini' and '$datafim'");
...
$odonto05virgilio = mysqli_query($con,"SELECT count(*) from senha where usuario_id = 104 AND data between '$dataini' and '$datafim'");
$odonto02luciana = mysqli_query($con,"SELECT count(*) from senha where usuario_id = 102 AND data between '$dataini' and '$datafim'");
...
while($row = mysqli_fetch_array($consultorio02fernandes)) {
  echo "<tr>";
  echo "<td>" ."Consultorio 02 - Fernandes". "</td>";
  echo "<td><center>" . $row['count(*)'] . "</center></td>";
  echo "</tr>";
}
...
while($row = mysqli_fetch_array($consultorio04rogerio)) {
  echo "<tr>";
  echo "<td>" ."Consultorio 04 - Rogerio". "</td>";
  echo "<td><center>" . $row['count(*)'] . "</center></td>";
  echo "</tr>";
}
while($row = mysqli_fetch_array($consultorio05ruber)) {
  echo "<tr>";
  echo "<td>" ."Consultorio 05 -Ruber"."</td>";
  echo "<td><center>" . $row['count(*)'] . "</center></td>";
  echo "</tr>";
}
while($row = mysqli_fetch_array($consultorio05manoel)) {
  echo "<tr>";
  echo "<td>" ."Consultorio 05 -Manoel"."</td>";
  echo "<td><center>" . $row['count(*)'] . "</center></td>";
  echo "</tr>";
}
...
while($row = mysqli_fetch_array($consultorio09rudney)) {
  echo "<tr>";
  echo "<td>" ."Consultorio 09 - Rudney"."</td>";
  echo "<td><center>" . $row['count(*)'] . "</center></td>";
  echo "</tr>";
}
...
while($row = mysqli_fetch_array($consultorio13anamelia)){
  echo "<tr>";
  echo "<td>" ."Consultorio 13 - Anamélia - TB-MH"."</td>";
  echo "<td><center>" . $row['count(*)'] . "</center></td>";
  echo "</tr>";
}
...
while($row = mysqli_fetch_array($psicologia02sheila)) {
  echo "<tr>";
  echo "<td>" ."Psicologia 02 - Sheila". "</td>";
  echo "<td><center>" . $row['count(*)'] . "</center></td>";
  echo "</tr>";
}
while($row = mysqli_fetch_array($nutricaomilena)){
  echo "<tr>";
  echo "<td>" ."Nutricao - Milena". "</td>";
  echo "<td><center>" . $row['count(*)'] . "</center></td>";
  echo "</tr>";
} 
while($row = mysqli_fetch_array($nutricaoraquel)){
  echo "<tr>";
  echo "<td>" ."Nutricao - Raquel". "</td>";
  echo "<td><center>" . $row['count(*)'] . "</center></td>";
  echo "</tr>";
} 
  while($row = mysqli_fetch_array($nutricaoroberta)){
  echo "<tr>";
  echo "<td>" ."Nutricao - Roberta". "</td>";
  echo "<td><center>" . $row['count(*)'] . "</center></td>";
  echo "</tr>";
}
...
while($row = mysqli_fetch_array($citologia_mamografia)){
  echo "<tr>";
  echo "<td>" ."Citologia_Mamografia". "</td>";
  echo "<td><center>" . $row['count(*)'] . "</center></td>";
  echo "</tr>";
}
...
while($row = mysqli_fetch_array($odonto01flavia)){
  echo "<tr>";
  echo "<td>" ."Odonto 01 - Flavia"."</td>";
  echo "<td><center>" . $row['count(*)'] . "</center></td>";
  echo "</tr>";
}
...
while($row = mysqli_fetch_array($odonto01karolline)){
  echo "<tr>";
  echo "<td>" ."Odonto 01 - Karolline"."</td>";
  echo "<td><center>" . $row['count(*)'] . "</center></td>";
  echo "</tr>";
}
...
while($row = mysqli_fetch_array($odonto01vanessa)){
  echo "<tr>";
  echo "<td>" ."Odonto 01 - Vanessa"."</td>";
  echo "<td><center>" . $row['count(*)'] . "</center></td>";
  echo "</tr>";
}
...
while($row = mysqli_fetch_array($odonto05virgilio)) {
  echo "<tr>";
  echo "<td>" ."Odonto 05 - Virgílio". "</td>";
  echo "<td><center>" . $row['count(*)'] . "</center></td>";
  echo "</tr>";
}
while($row = mysqli_fetch_array($odonto02luciana)) {
  echo "<tr>";
  echo "<td>" ."Odonto 02 - Luciana". "</td>";
  echo "<td><center>" . $row['count(*)'] . "</center></td>";
  echo "</tr>";
}
