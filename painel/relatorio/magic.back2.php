...
$consultorio12harley = mysqli_query($con,"SELECT count(*) from senha where usuario_id = 76 AND data between '$dataini' and '$datafim'");
...
while($row = mysqli_fetch_array($consultorio12harley)) {
  echo "<tr>";
  echo "<td>" ."Consultorio 12 -  harley". "</td>";
  echo "<td><center>" . $row['count(*)'] . "</center></td>";
  echo "</tr>";
}
