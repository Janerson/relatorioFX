...
$consultorio04francielle = mysqli_query($con,"SELECT count(*) from senha where usuario_id = 100 AND data between '$dataini' and '$datafim'");
...
$psicologia01citologia= mysqli_query($con,"SELECT count(*) from senha where usuario_id = 88 AND data between '$dataini' and '$datafim'");
...
$odonto01flavia = mysqli_query($con,"SELECT count(*) from senha where usuario_id = 45 AND data between '$dataini' and '$datafim'");
...
while($row = mysqli_fetch_array($consultorio04francielle)) {
  echo "<tr>";
  echo "<td>" ."Consultorio 04 - Francielle". "</td>";
  echo "<td><center>" . $row['count(*)'] . "</center></td>";
  echo "</tr>";
}
...
while($row = mysqli_fetch_array($psicologia02marcia)){
  echo "<tr>";
  echo "<td>" ."Psicologia 02 - Marcia". "</td>";
  echo "<td><center>" . $row['count(*)'] . "</center></td>";
  echo "</tr>";
}
...
while($row = mysqli_fetch_array($psicologia01citologia)){
  echo "<tr>";
